        ...
        <SafeAreaView style = {styles.container}>
            <ImageBackground source = {require('../../assets/city-background1.jpg')} style={styles.imageLayout}>
                ...
                <View style ={styles.riseSetWrapper}>
                    <IconText iconName = {'s'} iconColor = {'white'} bodyText = {'10:40'} bodyTextStyles={styles.riseSetText}></IconText>
                </View>
                                <View style ={styles.riseSetWrapper}>
                    <IconText iconName = {'sunset'} iconColor = {'white'} bodyText = {'10:40'} bodyTextStyles={styles.riseSetText}></IconText>
                </View>
            </ImageBackground>
        </SafeAreaView>
    )
