        ...
        <SafeAreaView style={container}>
            <ImageBackground source={require('../../assets/city-background1.jpg')} style={styles.imageLayout}>
                ...
                <View style={[riseSetWrapper,rowLayout]}>
                    <IconText iconName={'sunrise'} iconColor={'white'} bodyText={'10:40'} bodyTextStyles={riseSetText}></IconText>
                </View>
                <View style={[riseSetWrapper,rowLayout]}>
                    <IconText iconName={'sunset'} iconColor={'white'} bodyText={'18:40'} bodyTextStyles={riseSetText}></IconText>
                </View>
            </ImageBackground>
        </SafeAreaView>
    )
