/**
 * The `City` component is a React Native component that displays information about a city, including
 * its name, country, population, and sunrise/sunset times.
 * @returns The City component is being returned.
 */
